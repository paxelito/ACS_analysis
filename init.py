...
if __name__ == '__main__':
	...
	parser.add_argument('-a', '--sysType', help='System Architecture', default='1')
	...
	parser.add_argument('-m', '--maxDim', help='Max Dimension of the systems', default='6', type=int)
	parser.add_argument('-i', '--iteration', help='How many network per dimension must be created', default='10', type=int)
	parser.add_argument('-p', '--rctProb', help='Reaction Probability', default='0', type=float)
	parser.add_argument('-n', '--noCat', help='Non catalytic max length', default='2', type=float)
	parser.add_argument('-c', '--rctRatio', help='Ratio between cleavages and condensations', default='0', type=float)
